...
> Simple hide text in images (lsb encoding)

[![PyPI version](https://badge.fury.io/py/simple-steganography.svg)](https://pypi.org/project/simple-steganography/)
...
```bash
pip install simple-steganography
```

## Quick Start

```python
from simple_steganography import steganography
...
from simple_steganography import batch
